    ...
    return  BlocConsumer<NewsCubit,states>(
      ...
      builder: (context,state){
        return ConditionalBuilder(
            condition: NewsCubit.get(context).Sportss.length !=0 ,
            builder: (context)=> ListView.separated(
                    ...
                    Container(
                      ...
                      decoration:BoxDecoration(
                          ...
                          image:DecorationImage(
                              image:NetworkImage("${NewsCubit.get(context).Sportss[index]['urlToImage']}"),
                              fit: BoxFit.cover
                          )
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Expanded(
                              child: Text("${NewsCubit.get(context).Sportss[index]['title']}",
                ...
                itemCount: NewsCubit.get(context).Sportss.length
            ),
